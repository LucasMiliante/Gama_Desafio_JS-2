...
for (i; i < Produtos.length; i++) {
    Ids.push(Produtos[i].idDepto);
    NomeDep.push(Produtos[i].nomeDepto);
}
unicoIds = Ids.filter(unico);
unicoNomeDep = NomeDep.filter(unico);
//#endregion
...
var i = 0;
for (i; i < unicoIds.length; i++) {
    var j = 0;
    var totalItensDepartamento = 0;
    for (j; j < Produtos.length; j++) {
        if (Produtos[j].idDepto == unicoIds[i] ) {
            totalItensDepartamento += Produtos[j].qtdEstoque;
        }
    }
    console.log(`5.${unicoIds[i]}. O total de itens no departamento ${unicoIds[i]} - ${unicoNomeDep[i]} é de ${totalItensDepartamento}`);
}
//#endregion
...
for (i; i < unicoIds.length; i++) {
    ...
    console.log(`6.${unicoIds[i]}. O valor total do departamento ${unicoIds[i]} - ${unicoNomeDep[i]} é de R$ ${valorTotalItensDepartamento.toFixed(2)}`);
}
//#endregion
...
for (i; i < unicoIds.length; i++) {
    var j = 0;
    var ticketMedioInventarioDep = 0;
    var estoqueTotalDepartamento = 0;
    var ticketMedioProdutoDepartamento = 0;
    for (j; j < Produtos.length; j++) {
        if (Produtos[j].idDepto == unicoIds[i]) {
    ...
    console.log(`8.${unicoIds[i]}. O valor total do departamento ${unicoIds[i]} - ${unicoNomeDep[i]} é de R$ ${ticketMedioInventarioDep.toFixed(2)}`);
}
//#endregion
